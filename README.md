...
**Speaking at [Data Streaming Summit 2026](https://datastreaming-summit.org/dss2026)** in San
Francisco, Thursday, October 8, on *Your Agent's Memory Is Only as Good as the Pipeline
Behind It*. The short version: durable agent memory is a CDC problem wearing new clothes, and
an agent does not crash on wrong memory. It answers confidently.
...
hundreds of thousands of splits and putting the JobManager on the floor. Diagnosed and
fixed. **Merged, shipping in cdc-3.7.0.**

[FLINK-40697](https://github.com/apache/flink-cdc/pull/4550). The same metadata release,
generalized into flink-cdc-base so Postgres, SQL Server, Oracle, and Db2 get it instead of
each connector solving it on its own. Open, in review.
